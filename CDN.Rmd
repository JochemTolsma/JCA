...
attributes(liss_wide$origin_alter1.1)
attributes(liss_wide$origin.5)

#table(liss_long$origin, useNA="always")
...
liss_long %>%
  ...
  select(ego_id,  survey_wave, leeftijd, leeftijd_cat13,  opl4, geslacht, etni3, cdn_size, cdn_neduc_h, educ_EI, cdn_ngender_2, gender_EI, leeftijd_EI, etni_EI, origin_alter1_etni3, origin_alter2_etni3, origin_alter3_etni3, origin_alter4_etni3, origin_alter5_etni3) -> datajt

table(datajt$etni3, useNA = "always")
table(datajt$origin_alter1, useNA = "always")
table(datajt$origin_alter1_etni3, useNA = "always")
