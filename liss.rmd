...
```{r, echo=FALSE, fig.cap="CDN", out.width = '70%'}
...
- Education: low (primary, vbo), medium (MBO, HAVO, VWO), Professional college (HBO), University   
- Gender: male / female  
- Age: birth year  
- Ethnicity: native Dutch, non-western, western  
